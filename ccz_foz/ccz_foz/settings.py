"""
Django settings for ccz_foz project.
...
SECRET_KEY = '$9k=hw)w!(p1(jd1#tz+^=$oqbyzxprh^!3a0x01ry(pag=&w%'
...
WSGI_APPLICATION = 'ccz_foz.wsgi.application'
